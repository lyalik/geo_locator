...
- **Двойная система ИИ**: Mistral AI + YOLO для детекции нарушений
...
- Выбор методов анализа: Mistral AI, YOLO, или оба
...
- **🤖 Mistral AI**: Анализ ИИ с описанием на русском языке
...
- Точность детекции по источникам (Mistral AI vs YOLO)
...
- **Mistral AI**: 2-5 секунд обработки
...
2. **🤖 Двойная детекция нарушений**: Mistral AI + YOLO интеграция
